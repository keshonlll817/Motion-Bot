...
ALLOWED_CHANNELS = [
1471792196582637728,  # TEST_CHANNEL (test server)
1474078126630768822,
1479241150996152340,
1488259145093222522,
1452410545016930335,
1443356395935240302,  # FOUR_PLUS_CHANNEL (main server)
1446203029916356649,  # TOTALS_CHANNEL (main server)
]
...
# ==============================
    ...
    if content.startswith("!recap"):
        ...
        # Safety: if channels can't be resolved (bot not in that server / not cached),
        # fall back to current channel so the command never crashes with AttributeError.
...
# ==============================
    ...
    if total_plays == 0:
        ...
        conf_lines = [f"✅ **Slate posted** — {total_plays} play(s) loaded."]
        if four_plus:
